...
class Blockchain(object):
    ...
    def __init__(self) :
        #store all the block in the entire blockchain
        self.nodes = set()

        self.chain = []

        #temprarily store the transaction for the current block
    ...
    def valid_chain(self,chain) :
        ...
        current_index = 1  #start with the second block
...
def sync():
    ...
    if updated :
        response = {
            'message' : 'The blockchain has been update to the latest',
